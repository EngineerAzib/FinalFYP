      ...
      {showNotifications && (
        <View style={styles.notificationPanel}>
          <View style={styles.notificationHeader}>
            ...
            >
              <Text style={styles.notificationHeaderBtnText}>See All</Text>
            </TouchableOpacity>
          </View>
        ...
        >
          ...
          >
            <MaterialIcons
              name="dashboard"
              size={22}
              color={selectedTab === 'overview' ? '#4F46E5' : '#6B7280'}
            />
          ...
          <TouchableOpacity
            style={[styles.tab, selectedTab === 'academics' && styles.tabActive]}
            onPress={() => setSelectedTab('academics')}
          >
            <MaterialIcons
              name="school"
              size={22}
              color={selectedTab === 'academics' ? '#4F46E5' : '#6B7280'}
            />
            <Text style={[styles.tabText, selectedTab === 'academics' && styles.tabTextActive]}>
              Academics
            </Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={[styles.tab, selectedTab === 'people' && styles.tabActive]}
            onPress={() => setSelectedTab('people')}
          >
            <MaterialIcons
              name="people"
              size={22}
              color={selectedTab === 'people' ? '#4F46E5' : '#6B7280'}
            />
            <Text style={[styles.tabText, selectedTab === 'people' && styles.tabTextActive]}>
              People
            </Text>
          </TouchableOpacity>
          ...
          >
            <MaterialIcons
              name="event"
              size={22}
              color={selectedTab === 'schedule' ? '#4F46E5' : '#6B7280'}
            />
          ...
          >
            <MaterialIcons
              name="insert-chart"
              size={22}
              color={selectedTab === 'reports' ? '#4F46E5' : '#6B7280'}
            />
      ...
      >
        ...
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
          ...
          <View style={styles.examContainer}>
            {dashboardData.examSchedules.map((exam) => (
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('ExamScheduleDetails', { examId: exam.id })}
              >
          ...
          <View style={styles.regContainer}>
            {dashboardData.semesterRegistrations.map((reg) => (
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('SemesterRegistrationDetails', { regId: reg.id })}
              >
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('AllSemesterRegistrations')}
            >
          ...
          <View style={styles.quickActionsGrid}>
            ...
            <TouchableOpacity
              style={styles.quickActionCard}
              onPress={() => navigation.navigate('AddNewTeacher')}
            >
